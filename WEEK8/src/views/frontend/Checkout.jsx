            ...
            <div className="bg-white p-4 h-100 rounded">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <input
                  ...
                  placeholder="Email"
                  {...register("email", { required: "Email 必填" })}
                />
                {errors.email && (
                ...
                />
                {errors.name && (
                  <p className="text-danger small mb-2">{errors.name.message}</p>
                )}
                ...
                />
                {errors.tel && (
                  <p className="text-danger small mb-2">{errors.tel.message}</p>
                )}
                ...
                />
                {errors.address && (
                  <p className="text-danger small mb-2">{errors.address.message}</p>
                )}
          ...
          <div style={{ flex: "0 0 360px", maxWidth: "100%", minWidth: 0 }}>
            <div className="border bg-white p-4 h-100 rounded">
                ...
                carts.map((item) => (
                  ...
                  >
                    ...
                    <div className="ms-2 flex-grow-1" style={{ minWidth: 0 }}>
                      ...
                      <p className="text-end mb-0">{currency(item.final_total)}</p>
                    </div>
                  </div>
                ))
              )}
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <h5 className="mb-0">{currency(final_total)}</h5>
              </div>
            </div>
          </div>
        </div>
